...
#define KEY_NONUSHASH                                                                                   \
    50 /**< ISO USB keyboards actually use this code                                                    \
        ...
        *   you should generate #define KEY_BACKSLASH                                                   \
...
#define KEY_LWIN KEY_LGUI /**< windows command (apple) meta */
#define KEY_LMETA KEY_LGUI /**< windows command (apple) meta */
#define KEY_LCMD KEY_LGUI /**< windows command (apple) meta */
#define KEY_RCTRL 228
#define KEY_RSHIFT 229
#define KEY_RALT 230 /**< alt gr option */
#define KEY_RGUI 231 /**< windows command (apple) meta */
#define KEY_RWIN KEY_RGUI /**< windows command (apple) meta */
#define KEY_RMETA KEY_RGUI /**< windows command (apple) meta */
#define KEY_RCMD KEY_RGUI /**< windows command (apple) meta */
...
#define KEY_SLEEP 258 /**< Sleep */
#define KEY_WAKE 259 /**< Wake */

#define KEY_CHANNEL_INCREMENT 260 /**< Channel Increment */
#define KEY_CHANNEL_DECREMENT 261 /**< Channel Decrement */

#define KEY_MEDIA_PLAY 262 /**< Play */
#define KEY_MEDIA_PAUSE 263 /**< Pause */
#define KEY_MEDIA_RECORD 264 /**< Record */
#define KEY_MEDIA_FAST_FORWARD 265 /**< Fast Forward */
#define KEY_MEDIA_REWIND 266 /**< Rewind */
#define KEY_MEDIA_NEXT_TRACK 267 /**< Next Track */
#define KEY_MEDIA_PREVIOUS_TRACK 268 /**< Previous Track */
#define KEY_MEDIA_STOP 269 /**< Stop */
#define KEY_MEDIA_EJECT 270 /**< Eject */
#define KEY_MEDIA_PLAY_PAUSE 271 /**< Play / Pause */
#define KEY_MEDIA_SELECT 272 /* Media Select */

#define KEY_AC_NEW 273 /**< AC New */
#define KEY_AC_OPEN 274 /**< AC Open */
#define KEY_AC_CLOSE 275 /**< AC Close */
#define KEY_AC_EXIT 276 /**< AC Exit */
#define KEY_AC_SAVE 277 /**< AC Save */
#define KEY_AC_PRINT 278 /**< AC Print */
#define KEY_AC_PROPERTIES 279 /**< AC Properties */

#define KEY_AC_SEARCH 280 /**< AC Search */
#define KEY_AC_HOME 281 /**< AC Home */
#define KEY_AC_BACK 282 /**< AC Back */
#define KEY_AC_FORWARD 283 /**< AC Forward */
#define KEY_AC_STOP 284 /**< AC Stop */
#define KEY_AC_REFRESH 285 /**< AC Refresh */
#define KEY_AC_BOOKMARKS 286 /**< AC Bookmarks */
...
#define KEY_RESERVED 400 /**< 400-500 reserved for dynamic keycodes */

#define KEY_COUNT 512 /**< not a key just marks the number of scancodes for array bounds */

/**
 * @brief Keyboard key. Use KEY_<your_key>
 *
 * @api
 */
typedef u16 Key;
